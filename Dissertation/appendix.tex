...
\lstinputlisting[language={c}, firstline=1, lastline=29, label={extras:c_defs}]{listings/lexing/def.h}
\clearpage
\newgeometry{a4paper, top=2cm, bottom=2cm, left=3cm, right=1cm, nomarginpar, includehead} %, heightrounded, showframe

\lstinputlisting[language={c}, firstline=30 firstnumber=30, caption={defs.h}]{listings/lexing/def.h}
